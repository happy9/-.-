...
if __name__ = "__main__":
    ...
    print("\nЗадача 4.\n", bin_search([2,5,7,9,11,17,222], 11))
    ...
    print("\nЗадача 6.\n", calculate("test_input_file_1.txt"))

    print("\nЗадача 7.\n",substring_slice("test_import_file_2_11.txt", "test_import_file_2_22.txt"))
    ...
    print(student1.mean_grade())
    print(student1.is_otlichnik())
    student1 + student2
